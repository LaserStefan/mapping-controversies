...
Für den eigenen Nachbau: ```/_pages``` anpassen, Bilder und Materialien liegen unter ```/assets```.

### Theme

Die Seite basiert auf dem Jekyll-Theme [Minimal Mistakes](https://mmistakes.github.io/minimal-mistakes/). 
